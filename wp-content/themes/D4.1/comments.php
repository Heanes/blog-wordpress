...
?>
<div id="postcomments">
<div id="comments-div"><span id="comments-addcomment"><a href="#respond" rel="nofollow" title="Leave a comment ?">Leave a comment</a></span><h3 id="comments">
...
<div id="respond" class="no_webshot">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<?php } } ?>
		<div class="post-area">
			<div id="smiley" class="toggle"><?php dtheme_smilies(); ?></div>
			<div class="post-area-txt"><?php echo stripslashes(get_option('d_commentarea')); ?></div>
		...
		<div class="subcon">
			<input class="btn primary" type="submit" name="submit" id="submit" tabindex="5" value="提交评论" />
