		...
		<div class="contact" style="padding:30px;">
			...
			<form action="" id="wr" name="wr" class="index_contact_form">
				<div class="contact_form_inner_form">
					...
					<input type="text" name="name" id="form_name" style="padding:3px;border:1px solid #ccc;"/>
					<div class="index_contact_form_title">邮箱</div>
					<input type="text" name="email" id="form_email" style="padding:3px;border:1px solid #ccc;"/>
					<div class="index_contact_form_title">网站</div>
					<input type="text" name="website" id="form_website" style="padding:3px;border:1px solid #ccc;"/>
					<div class="index_contact_form_title">内容</div>
					<textarea name="message" id="form_message" style="height:100px;padding:10px;border:1px solid #ccc;width:96.5%;" cols="" rows=""></textarea>
					<input type="button" value="发送邮件" class="contact_form_submit" onclick="initrequest('<?php bloginfo('template_url'); ?>/inc/form.php');" style="cursor:pointer;background: #04a4cc;width:87px;height:35px;color: #fff;text-align:center;margin:10px 0 0 0;border:0px;border-radius:2px;"/>
				</div>
			</form>
		</div>
	</section>
